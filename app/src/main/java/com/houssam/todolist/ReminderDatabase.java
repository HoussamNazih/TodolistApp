...
public class ReminderDatabase extends SQLiteOpenHelper {
    ...
    // Table name
    private static final String TABLE_REMINDERS = "MYToDoListTable";

    // Table Columns names
    private static final String KEY_ID = "id";
    private static final String KEY_TITLE = "titlee";
    private static final String KEY_Desc = "descriptionn";
    ...
    public int addReminder(Reminder reminder){
        ...
        Cursor c = db.rawQuery("SELECT * FROM MYToDoListTable WHERE 0", null);
        String[] columnNames = c.getColumnNames();

        /*for(String log : columnNames)
        {
            Log.v("DB",log);
        }*/
    ...
    // Getting  Reminders by titre
    public List<Reminder> getReminders(String titre){
        List<Reminder> reminderList = new ArrayList<>();

        // Select all Query
        String selectQuery = "SELECT * FROM " + TABLE_REMINDERS+" WHERE titlee like '%"+titre+"%'";
    ...
    public List<Reminder> getRemindersType(String type){
        List<Reminder> reminderList = new ArrayList<>();

        // Select all Query
        String selectQuery = "SELECT * FROM " + TABLE_REMINDERS+" WHERE type ='%"+type+"%'";
    ...
    public List<String> getTitles(){
        ...
        // Select all Query
        String selectQuery = "SELECT titlee FROM " + TABLE_REMINDERS;
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                reminderList.add(cursor.getString(0));
            } while (cursor.moveToNext());
        }
        return reminderList;
    }
