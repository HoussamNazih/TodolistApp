...
public class ReminderAddActivity extends AppCompatActivity implements
    ...
    private EditText mTitleText, mDescText , mTypeText;
    private TextView mDateText, mTimeText, mRepeatText, mNotifText, mRepeatNoText, mRepeatTypeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDescText = (EditText) findViewById(R.id.reminder_desc);
        Intent myIntent = getIntent();


        if (myIntent.hasExtra("titreIntent") )
        {
            mTitleText.setText(myIntent.getStringExtra("titreIntent"));
        }
        ...
        getSupportActionBar().setTitle("Ajouter une tâche");
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_Type, mTypeText.getText());
    ...
    public void onSwitchNotif(View view) {
        ...
        if (on) {
            mActive = "true";
            mNotifText.setText("Activée");
        } else {
            mActive = "false";
            mNotifText.setText("Off");
        }
    }
    ...
    public void saveReminder(){
        ...
        // Creating Reminder
        int ID = rb.addReminder(new Reminder(mTitle,mDescText.getText().toString(),mType,mDate, mTime, mRepeat, mRepeatNo, mRepeatType,mActive));
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0)
                    ...
                    mDescText.setError("Reminder Description cannot be blank!");
